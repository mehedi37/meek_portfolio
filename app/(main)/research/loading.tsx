    ...
    <div className="min-h-screen pt-24 pb-16">
      <Container>
        ...
        <div className="mb-12 animate-pulse">
          ...
          <div className="h-12 w-48 bg-secondary/50 rounded mb-4" />
        ...
        <div className="mb-8 space-y-4 animate-pulse">
          <div className="flex gap-3">
            <div className="h-8 w-20 bg-secondary/50 rounded-full" />
            <div className="h-8 w-20 bg-secondary/50 rounded-full" />
            <div className="h-8 w-20 bg-secondary/50 rounded-full" />
          </div>
          <div className="flex gap-2">
            <div className="h-6 w-16 bg-secondary/30 rounded" />
            <div className="h-6 w-20 bg-secondary/30 rounded" />
            <div className="h-6 w-14 bg-secondary/30 rounded" />
            <div className="h-6 w-18 bg-secondary/30 rounded" />
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {[...Array(9)].map((_, i) => (
            ...
            >
              <div className="bg-card/50 rounded-xl overflow-hidden border border-border/30">
                {/* Image skeleton */}
